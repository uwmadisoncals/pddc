...
while (have_posts()) : the_post();
		...
		?>
		<a href="<?php echo $blog_path ?>/files/Fact_Sheets/LC_PDF/<?php printf( get_field('fact_sheet_filename_stem')) ?>.pdf" target="_blank">Low Color PDF</a><br />
		...
		echo "<td style='text-align: center; border: 1px solid #28361b;'>"; ?>
		<a href="<?php echo $blog_path ?>/files/Fact_Sheets/LC_Word/<?php printf( get_field('fact_sheet_filename_stem')) ?>.pdf" target="_blank">Low Color Word</a><br />		
