 ...
 *
 Template Name: Fact_Sheet_Listing_on_Posts__General_Hort_Weeds
 * @package WordPress
...
query_posts(array('orderby' => 'title', 'cat' => 168, 'order' => 'ASC', 'showposts' => -1));
...
<br />
<div style="font-size: 24px; font-family: Verdana; font-weight: bold;">Fact Sheet Listing - General Horticulture/Weeds</div>	
