...
<div> 
	<span class="field-labels">Authors:</span> <?php printf( get_field('authors')); ?>
</div>

<div> 
	<span class="field-labels">Last Revised:</span> 
	<?php 
...
<div>
	<span class="field-labels">X-number:</span> <?php printf( get_field('fact_sheet_x-number')); ?>
</div>
