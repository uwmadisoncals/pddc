 ...
 *
 Template Name: Fact_Sheet_Listing_on_Posts_DWO
 * @package WordPress
...
query_posts(array('orderby' => 'title', 'cat' => 144, 'order' => 'ASC', 'showposts' => -1));
...
<br />
<div style="font-size: 24px; font-family: Verdana; font-weight: bold;">Fact Sheet Listing - Diseases - Deciduous Woody Ornamentals</div>	
