...
query_posts(array('orderby' => 'title', 'cat' => 141, 'order' => 'ASC', 'showposts' => -1));
...
<br />
<div style="font-size: 24px; font-family: Verdana; font-weight: bold;">Fact Sheet Listing - <?php echo category_description( $category_id ); ?></div>	
